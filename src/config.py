...
STAGE_NAME = "Stage 2"
MODEL_VERSION = "stage2-v2.1"
TOP_N = 5
# Broad NSE equity universe. Expensive ML is applied only after prescreening.
MAX_UNIVERSE = 1000
PRESCREEN_N = 60
HISTORY_PERIOD = "2y"
...
NIFTY_SYMBOL = "^NSEI"
# A broad NSE list is preferred; local Nifty lists are fallback sources only.
