...
def train_stock_bundle(df, symbol, cutoff_date, variant="A", train_horizons=False):
    ...
    # Raw volume is extremely skewed; log1p produces a much more stable target.
