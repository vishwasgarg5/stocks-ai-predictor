...
def run():
    ...
    bucket=_bucket_metrics(evaluation,predictions);report=evening_report(market_date,evaluation,metrics,retraining,bucket_metrics=bucket,learning={"status":"UPDATED"});send_telegram(report);print(report)
