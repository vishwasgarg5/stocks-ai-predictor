...
def test_stage10_candidate_to_morning_report_integration():
    ...
    report = morning_report(
        "2026-09-03", "2026-09-02", candidates, pd.DataFrame(), pd.DataFrame(),
        market_snapshot={"NIFTY": {}, "BANKNIFTY": {}, "FINNIFTY": {}, "VIX": {}, "Breadth": {}},
        regime="BULL", accuracy={"PreviousAccuracy": 70, "CurrentAccuracy": 72, "AccuracySamples": 20},
...
def test_stage10_evening_report_integration():
    ...
    report = evening_report(
        ...
        bucket_metrics={"B3": 99.6}, learning={"status": "UPDATED"},
